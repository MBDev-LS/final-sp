...
# Idea: Checking validity of a move - currently just moves on if invalid move is inputted (See WikiBooks)
# Author: Louis
	...
	def PlayGame(self):
		...
		while not GameOver:
			...
			while MoveLegal is not True:
				...
				print('\nERROR: Cannot move to that square. Please enter a valid square to move to.\n')
