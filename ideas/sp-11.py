...
class Dastan:
	...
	def __DisplayBoard(self, board=None):
		...
		for Row in range(1, self._NoOfRows + 1):
			...
			for Column in range(1, self._NoOfColumns + 1):
				...
				print("|" + board[Index].GetSymbol(), end="")
				PieceInSquare = board[Index].GetPieceInSquare()
	...
	def PlayGame(self):
		...
		while not GameOver:
			...
			# print(self.GetMoveOptionInPosition(Choice-1))
...
class Piece:
	...
	def SetSymbol(self, newSymbol) -> None:
